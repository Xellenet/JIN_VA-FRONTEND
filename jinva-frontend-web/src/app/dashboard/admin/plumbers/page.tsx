...
import { mockUsers, mockPlumbers } from "@/lib/data/mock-data"
        ...
        <Card>
          <CardHeader>
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <CardTitle className="text-2xl font-bold">Plumbers</CardTitle>
                <p className="text-sm text-muted-foreground">Manage and track all plumbers in your team.</p>
              </div>
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="mt-14 space-y-3 p-4 text-center">
                      ...
                      >
                        ...
                        {plumber.availability === "available" ? "Active" : "Busy"}
                      </Badge>
                    </div>
                  </CardContent>
                </Card>
