...
export function LoginForm() {
  ...
  return (
    <AuthSplitLayout>
      <div className="space-y-8 bg-white md:rounded-lg md:p-8 p-4 w-full md:w-auto md:border-0">
        {/* Header */}
        <div className="space-y-2">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900">Sign In</h1>
          <p className="text-gray-600">
            {"Don't have an account? "}
            <Link href="/signup" className="text-gray-900 underline hover:text-gray-700 transition-colors">
              Create now
            </Link>
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {unverifiedEmail && (
            <div className="rounded-md border border-amber-200 bg-amber-50 p-3 text-sm text-amber-900">
              ...
              <button
                ...
                className="mt-1 font-medium underline underline-offset-2 hover:text-amber-700 disabled:opacity-60"
              >
          ...
          {/* G10: social-only account — shown distinctly from the generic
              invalid-credentials toast, with a direct Google shortcut. */}
          {socialOnlyError && (
            <div className="rounded-md border border-blue-200 bg-blue-50 p-3 text-sm text-blue-900 space-y-2">
              ...
              <Button
                ...
                className="w-full h-9 border border-gray-800 bg-gray-900 hover:bg-gray-800 font-normal text-gray-400 hover:text-gray-400 transition-colors"
              >
                <svg className="mr-3 h-4 w-4 text-gray-400" viewBox="0 0 24 24" fill="currentColor">
