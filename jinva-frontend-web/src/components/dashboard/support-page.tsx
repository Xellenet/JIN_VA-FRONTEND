...
const faqsByRole: Record<UserRole, { question: string; answer: string; category: string }[]> = {
  user: [
    { category: "Booking", question: "How do I book a plumber?", answer: "Navigate to 'Find Plumbers' from the sidebar, browse available plumbers by specialization, rating, or availability, then click 'Book Now' on any plumber card. Fill in the booking form with your service details, preferred date and time, and submit your request." },
    ...
    { category: "Payment", question: "How do refunds work?", answer: "If a booking is cancelled before the plumber arrives, a full refund is issued within 3-5 business days. If the job was partially completed, a proportional refund will be calculated and processed." },
    ...
    { category: "Service", question: "How are plumber ratings calculated?", answer: "Plumber ratings are based on an average of all client reviews. After each completed job, clients can leave a star rating (1-5) and a written review. The overall rating reflects the plumber's quality and reliability over time." },
    { category: "Safety", question: "Are the plumbers verified?", answer: "Yes, all plumbers on Plumbify undergo a thorough verification process including identity checks, license verification, insurance confirmation, and background checks before being approved on the platform." },
  ],
  plumber: [
  ...
  admin: [
    { category: "Management", question: "How do I add or remove a plumber?", answer: "Go to the Plumbers section and click 'Add Plumber' to register a new plumber. To remove a plumber, find their card, click the options menu, and select 'Remove'. The plumber will be notified of their account deactivation." },
    ...
    { category: "Orders", question: "How do I handle order disputes?", answer: "Go to Orders, find the disputed order, and click 'View Details'. Review the client and plumber communication, then use the admin tools to resolve the dispute by issuing a refund, reassigning the job, or mediating between parties." },
    ...
    { category: "Reports", question: "What analytics are available?", answer: "The Report section provides comprehensive analytics including revenue trends, order volume, plumber performance rankings, client retention rates, service category breakdowns, and downloadable CSV/PDF exports." },
    { category: "System", question: "How do I broadcast a system announcement?", answer: "Go to Admin Settings, then the Notifications tab. Use the 'System Announcements' section to compose and send platform-wide notifications to all users, plumbers, or specific user groups." },
  ],
}
